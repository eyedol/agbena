...
CREATE TABLE IF NOT EXISTS `j_category` (
  ...
  `parent_id` INT NOT NULL DEFAULT '0',
  `locale` varchar(10) NOT NULL default 'en_US',
  `job_category_type` tinyint(4) default NULL,
  `job_category_title` varchar(255) default NULL,
  `job_category_description` text default NULL,
  `job_category_color` varchar(20) default NULL,
  `job_category_image` varchar(100) default NULL,
  `job_category_image_shadow` varchar(100) default NULL,
  `job_category_visible` tinyint(4) NOT NULL default '1',
  PRIMARY KEY  (`id`),
  KEY `job_category_visible` (`job_category_visible`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `job` (
  ...
  `job_mode` tinyint(4) NOT NULL default '1' COMMENT '1 - WEB, 2 - SMS, 3 - EMAIL, 4 - TWITTER',
  `job_active` tinyint(4) NOT NULL default '0',
  `job_verified` tinyint(4) NOT NULL default '0',
  `job_dateadd` datetime default NULL,
  `job_dateadd_gmt` datetime default NULL,
  `job_datemodify` datetime default NULL,
  `job_alert_status` TINYINT NOT NULL DEFAULT '0' COMMENT '0 - Not Tagged for Sending, 1 - Tagged for Sending, 2 - Alerts Have Been Sent',
  PRIMARY KEY  (`id`),
  UNIQUE KEY `location_id` (`location_id`),
  KEY `job_active` (`job_active`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `job_person` (
  ...
  `person_phone` varchar(60) default NULL,
  `person_ip` varchar(50) default NULL,
  `person_web` varchar(50) default NULL,
  `person_date` datetime default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
