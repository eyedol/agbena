...
<div id="content">
	<div class="content-bg">
		...
		<div class="big-block">
			...
			<div style="-moz-background-clip:border;-moz-background-inline-policy:continuous;-moz-background-origin:padding;background:#F9F8F5 none repeat scroll 0 0;border:1px dashed #DDDCDC;font-size:14px;margin:15px;padding:10px 15px;">
			...
			<div id="contact_us" class="contact">
				...
				?>
					<!-- green-box -->
					<div class="green-box">
						<h3>Your Message Has Been Sent! <a href="<?php echo $previous_page ?>">To previous page</a></h3>
					</div>
				<?php
				}								
				?>
