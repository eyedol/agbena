...
?>
		...
		$(document).ready(function() {
		    ...
		    $('#add_new_category').click(function() { 
				...
				$.post("<?php echo url::base() . 'admin/jobs/save_category/' ?>", { job_category_title: job_category_name, job_category_description: job_category_description, job_category_color: job_category_color },
					function(data){
						if ( data.status == 'saved')
						{
							
					        $('#user_categories').append("<li><label><input type=\"checkbox\"name=\"job_category[]\" value=\""+data.id+"\" class=\"check-box\" checked />"+job_category_name+"</label></li>");
							$('#job_category_add').hide();
						}
						else
						{
