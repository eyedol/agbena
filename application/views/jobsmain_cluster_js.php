...
?>
		...
		var json_url = "jobs_json_cluster";
		...
		jQuery(function() {
			...
			*/
				...
				sliderOptions: {
					change: function(e, ui) {
						...
						if ((endTime - startTime) / (1000 * 60 * 60 * 24) <= 3){
							...
							json_url = "jobs_json_cluster";
						}

						// Refresh Map
						addMarkers(currCat, startDate, startDate, '', '', gMediaType);
						
						refreshGraph(startDate, startDate);
					}
				}
			});
			...
			// Initialize Map
			addMarkers(gCategoryId, '','', '', '', gMediaType);
			refreshGraph('','');
		...
		*/
		function addMarkers(catID,startDate,endDate, currZoom, currCenter,
			...
			var thisLayer = "Jobs"; // Default Layer Name
